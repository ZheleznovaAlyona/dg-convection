...
namespace solver
{
	...
	{
	public:
		myvector::MyVector solve(myvector::MyVector& U_begin, double &normL2u, slae::SLAE& slae_in, logger::Logger& my_logger);
	};

	class BiCGStab : public Solver
	{
	public:
		myvector::MyVector solve(myvector::MyVector& U_begin, double &normL2u, slae::SLAE& slae_in, logger::Logger& my_logger) final;
	};
